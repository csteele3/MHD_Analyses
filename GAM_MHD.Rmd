...
###Comparing Year in the model with and without a smooth###
...
plot(gam_modSS, pages = 1, trans = plogis,
     shift = coef(gam_mod)[1], seWithMean = TRUE, rug = TRUE, shade = TRUE, shade.col = "lightgreen", 
     col = "purple")
...
vis.gam(gam_mod, n.grid = 50, theta = 400, phi = 20, ylab = "Day of Year", xlab = "Year", zlab = "",
...
```{r}
vis.gam(gam_mod,  plot.type = "contour", ylab = "Day_Year", xlab = "Year.Sampled", color = "terrain", main = "Interaction between day of year and season", theme(legend.position = "top"))

vis.gam(x= gam_mod,plot.type = "contour",color="heat",theta=-35)  
